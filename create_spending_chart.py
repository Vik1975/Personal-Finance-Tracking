...
bars = ax.bar(categories, amounts, color=colors[:len(categories)], edgecolor='black', linewidth=1.5)
...
plt.figtext(0.99, 0.01, f'Total Spending: ${total_categorized:.2f}',
            ha='right', fontsize=11, style='italic', color='gray')
