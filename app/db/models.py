...
from sqlalchemy import String, Integer, Numeric, Date, DateTime, ForeignKey, Text, Boolean, Enum as SQLEnum
...
class Transaction(Base):
    ...
    line_items: Mapped[list["LineItem"]] = relationship(back_populates="transaction", cascade="all, delete-orphan")
